...
{
    public partial class frmTransInfo : Form
    {
        string idOrder = "\0";
        string userID;
        bool fromAccount;
        bool isPurch = true;
        public frmTransInfo(string orderID, bool isPurchase,string empID,bool fromAcc)
        {
            InitializeComponent();
            idOrder = orderID;
            isPurch = isPurchase;
        ...
        void gridfill()
        {
            ...
            SqlCommand carInfoCmd = new SqlCommand(carInfoQuery, SqlInfo.con);
            ...
            SqlCommand empInfoCmd = new SqlCommand(empInfoQuery, SqlInfo.con);
            ...
            SqlCommand sellerCustInfoCmd = new SqlCommand(cust_manufQuery, SqlInfo.con);
            ...
            SqlCommand orderInfoCmd = new SqlCommand(orderInfoQuery, SqlInfo.con);
